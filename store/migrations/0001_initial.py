# Generated by Django 3.1.12 on 2022-01-11 18:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sport', models.CharField(default=None, max_length=120)),
                ('name', models.CharField(default=None, max_length=120)),
                ('link', models.CharField(default=None, max_length=120)),
                ('sortno', models.PositiveIntegerField()),
                ('status', models.CharField(choices=[('available', 'Available'), ('shipping', 'Shipping'), ('out for delivery', 'Out for Delivery'), ('delivered', 'Delivered'), ('returning', 'Returning')], max_length=20)),
                ('created_date', models.DateField(auto_now_add=True)),
